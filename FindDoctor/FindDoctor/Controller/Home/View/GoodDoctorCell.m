...
- (void)initSubViews{
    ...
    //擅长
    goodAtLabel = [[UILabel alloc] initWithFrame:CGRectMake(name.frameX, name.maxY + 8 * VFixRatio6, 32 * HFixRatio6, 15 * VFixRatio6)];
    goodAtLabel.text = @"擅长：";
    ...
    //好评
    goodCommentLabel = [[UILabel alloc] initWithFrame:CGRectMake(goodAtLabel.frameX, goodAtLabel.maxY + 8 * VFixRatio6, goodAtLabel.frameWidth, goodAtLabel.frameHeight)];
