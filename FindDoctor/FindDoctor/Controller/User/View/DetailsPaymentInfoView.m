...
//
#define DetailsPaymentInfoViewHeight 140
...
- (void)initSubViews{
    ...
    self.line1.backgroundColor = kLightLineColor;
    [self addSubview:self.line1];
    
    self.orderAmountLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 42, 60, 18)];
    self.orderAmountLabel.text = @"订单总额:";
    self.orderAmountLabel.textColor = kLightGrayColor;
    ...
    self.orderDiscountLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, self.orderAmountLabel.maxY + 10, 60, 18)];
    self.orderDiscountLabel.text = @"订  金  券:";
    self.orderDiscountLabel.textColor = kLightGrayColor;
    ...
    self.line2 = [[UIView alloc] initWithFrame:CGRectMake(10, self.orderDiscountLabel.maxY + 10, kScreenWidth - 10, 0.5)];
     self.line2.backgroundColor = kLightLineColor;
    [self addSubview:self.line2];
    
    self.cashLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, self.line2.maxY + 15, 60, 18)];
    self.cashLabel.text = @"现金支付:";
    self.cashLabel.textAlignment = NSTextAlignmentLeft;
    self.cashLabel.font = [UIFont systemFontOfSize:12];
    self.cashLabel.textColor = kLightGrayColor;
    [self addSubview:self.cashLabel];
    
    self.orderAmount = [[UILabel alloc] initWithFrame:CGRectMake(self.orderAmountLabel.maxX + 2, self.orderAmountLabel.frameY, kScreenWidth - self.orderAmountLabel.maxX - 2 - 12, self.orderAmountLabel.frameHeight)];
    ...
    self.orderDiscount = [[UILabel alloc] initWithFrame:CGRectMake(self.orderDiscountLabel.maxX + 2, self.orderDiscountLabel.frameY, kScreenWidth - self.orderDiscountLabel.maxX - 2 - 12, self.orderDiscountLabel.frameHeight)];
    ...
    self.cash = [[UILabel alloc] initWithFrame:CGRectMake(self.cashLabel.maxX + 2, self.cashLabel.frameY - 7, kScreenWidth - self.cashLabel.maxX - 2 - 12, 25)];
    self.cash.textAlignment = NSTextAlignmentRight;
    self.cash.font = [UIFont systemFontOfSize:20];
