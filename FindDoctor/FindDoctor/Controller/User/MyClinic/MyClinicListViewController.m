...
@interface MyClinicListViewController ()<DOPDropDownMenuDataSource, DOPDropDownMenuDelegate>
...
@implementation MyClinicListViewController
...
{
    return [MyClinicCell defaultHeight];
}
