...
- (instancetype)initWithOrigin:(CGPoint)origin andHeight:(CGFloat)height {
    ...
    if (self) {
        ...
        self.tableView.separatorColor = UIColorFromHex(Color_Hex_Tableview_Separator);
...
//        _backGroundView.opaque = NO;
        ...
        bottomShadow.backgroundColor = UIColorFromHex(Color_Hex_Tableview_Separator);
...
//    [(CATextLayer *)self.titles[column] setForegroundColor:self.textColor.CGColor];
//    [(CAShapeLayer *)self.indicators[column] setFillColor:self.indicatorColor.CGColor];
