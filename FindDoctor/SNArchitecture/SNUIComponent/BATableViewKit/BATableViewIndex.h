...
@property CGFloat letterHeight;
@property CGFloat letterSpace;
@property CGFloat letterFontSize;

@property CGRect shapeFrame;  // 背景rect
@property CGFloat shapeCornerRadius;  // 背景圆角

@property (nonatomic, strong) UIColor *letterColor;
@property (nonatomic, strong) UIColor *shapeColor;  // 背景颜色
