...
@interface PLSqliteDatabaseOnThread (PLSqliteDatabasePrivate)
 ...
 */
@implementation PLSqliteDatabaseOnThread
...
- (id) initWithPath: (NSString*) dbPath {
    ...
    _path = [dbPath retain];
    database_queue = dispatch_queue_create("com.sina.sinanews.database_queue", 0);
 ...
 */
@implementation PLSqliteDatabaseOnThread (PLSqliteDatabaseLibraryPrivate)
 ...
 */
@implementation PLSqliteDatabaseOnThread (PLSqliteDatabasePrivate)
