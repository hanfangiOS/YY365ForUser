...
/**
 * Called when imageData download is completed successfuly.
 *
 * @param imageManager The image manager
 * @param imageData The retrived NSData object
 * @param url The image URL used to retrive the image
 * @param info The user info dictionnary
 */
- (void)webImageManager:(SDWebImageManager *)imageManager
 didFinishWithImageData:(NSData *)imageData
                 forURL:(NSURL *)url
...
// WARNING: add by nova
- (void)webImageManager:(SDWebImageManager *)imageManager didFinishWithImage:(UIImage *)image forURL:(NSURL *)url imageSize:(NSInteger)size;
/**
